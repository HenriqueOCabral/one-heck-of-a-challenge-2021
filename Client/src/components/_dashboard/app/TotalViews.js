...
import playSquareOutlined from '@iconify/icons-ant-design/play-square-outlined';
// material
...
const TOTAL = faker.datatype.number({ min: 1000000, max: 10000000, precision: 1 });

export default function TotalViews() {
  return (
    <RootStyle>
      <IconWrapperStyle>
        <Icon icon={playSquareOutlined} width={24} height={24} />
      </IconWrapperStyle>
